...
### Comparativa Visual de Capas (Mermaid)

```mermaid
graph TD
    subgraph Modelo OSI (7 Capas)
        O7[7. Aplicación]
        O6[6. Presentación]
        O5[5. Sesión]
        O4[4. Transporte]
    ...
    subgraph Modelo TCP/IP (4 Capas)
        T4[4. Aplicación]
        T3[3. Transporte]
        T2[2. Internet]
...
| :--- | :--- | :--- |
| **7. Aplicación**<br>**6. Presentación**<br>**5. Sesión** | **4. Capa de Aplicación** | HTTP, HTTPS, SSH, FTP, SMTP, DNS, DHCP |
| **4. Transporte** | **3. Capa de Transporte** | TCP, UDP |
| **3. Red** | **2. Capa de Internet** | IP (IPv4/IPv6), ICMP, IPsec |
| **2. Enlace de Datos**<br>**1. Física** | **1. Capa de Acceso a la Red** | Ethernet, Wi-Fi (802.11), ARP, Hardware (Hubs, cables) |
